      ...
      <article className="max-w-3xl mx-auto px-6 py-12 md:py-20">
        ...
        <div className="space-y-6 mb-12">
          ...
          <div>
            ...
            <p className="text-slate-600">Yes — at any time. Email <a href="mailto:alex@avahealth.co" className="underline text-blue-600 hover:text-blue-700">alex@avahealth.co</a> with the subject &ldquo;Delete my profile&rdquo; and we&apos;ll wipe both the resume file and parsed data within 30 days, including from any active employer match queues.</p>
          </div>
          <div>
