 ...
 *
 * Talks to the Gemini REST API directly via fetch() instead of the
 * @google/genai SDK -- this file only ever makes one generateContent call,
 * so pulling in the full client library isn't worth the weight.
 */
