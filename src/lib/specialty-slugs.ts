...
export const CANDIDATE_SPECIALTIES: CandidateSpecialty[] = [
  ...
  },
  {
    ...
    title: 'PTA / Physical Therapy Assistant resume upload',
    metaDescription: 'Free PTA resume upload. Licensed Physical Therapy Assistants matched to outpatient ortho, SNF, home health, acute, and pediatric openings nationwide.',
    shortDescription: 'PTA roles across outpatient ortho, skilled nursing, home health, acute rehab, and pediatric clinics.',
    commonCredentials: ['PTA', 'Licensed PTA'],
    exampleRoles: ['Outpatient Ortho PTA', 'SNF PTA', 'Home Health PTA', 'Acute Rehab PTA', 'Pediatric PTA', 'Travel PTA'],
  },
  {
    slug: 'occupational-therapy-assistant',
    name: 'Occupational Therapy Assistant',
    title: 'COTA / Occupational Therapy Assistant resume upload',
    metaDescription: 'Free COTA resume upload. Certified Occupational Therapy Assistants matched to SNF, home health, school, peds, and outpatient openings nationwide.',
    shortDescription: 'COTA roles across skilled nursing, home health, schools, peds, hand therapy, and outpatient rehab.',
    commonCredentials: ['COTA', 'COTA/L', 'Licensed OTA'],
    exampleRoles: ['SNF COTA', 'Home Health COTA', 'School-based COTA', 'Pediatric COTA', 'Hand Therapy COTA', 'Travel COTA'],
  },
  {
    slug: 'phlebotomist',
    name: 'Phlebotomist',
    title: 'Phlebotomist resume upload',
    metaDescription: 'Free phlebotomist resume upload. Certified phlebotomy techs matched to hospital, draw-station, plasma, donor center, and mobile phlebotomy openings.',
    shortDescription: 'Phlebotomy roles across hospital labs, outpatient draw stations, plasma centers, blood donor centers, and mobile teams.',
    commonCredentials: ['CPT', 'PBT (ASCP)', 'NCCT', 'NHA CPT'],
    exampleRoles: ['Hospital Phlebotomist', 'Outpatient Draw Station', 'Plasma Center Phlebotomist', 'Donor Center Tech', 'Mobile Phlebotomist', 'Lead Phlebotomy Tech'],
  },
  {
    slug: 'patient-care-tech',
    name: 'Patient Care Tech',
    title: 'PCT / Patient Care Technician resume upload',
    metaDescription: 'Free PCT resume upload. Patient Care Technicians and Nurse Aides matched to med-surg, ED, telemetry, ICU, and dialysis openings nationwide.',
    shortDescription: 'PCT roles across med-surg, telemetry, ICU, ED, dialysis, and post-acute floors.',
    commonCredentials: ['PCT', 'CNA', 'CCT', 'EKG-certified', 'Phlebotomy-trained'],
    exampleRoles: ['Med-Surg PCT', 'Telemetry PCT', 'ICU PCT', 'ED Tech', 'Dialysis Tech', 'Float Pool PCT'],
  },
  {
    slug: 'sleep-tech',
    name: 'Sleep Tech',
    title: 'RPSGT / Sleep Tech resume upload',
    metaDescription: 'Free sleep tech resume upload. RPSGT, RST, and Polysomnographic Techs matched to in-lab and home sleep test (HST) openings nationwide.',
    shortDescription: 'Sleep tech roles across hospital sleep labs, freestanding sleep centers, and home sleep testing.',
    commonCredentials: ['RPSGT', 'RST', 'CPSGT', 'BRPT'],
    exampleRoles: ['In-Lab Polysomnographic Tech', 'Pediatric Sleep Tech', 'Home Sleep Test Coordinator', 'Lead Sleep Tech', 'Sleep Lab Manager'],
  },
  {
    slug: 'dental-hygienist',
    name: 'Dental Hygienist',
    title: 'RDH / Dental Hygienist resume upload',
    metaDescription: 'Free dental hygienist resume upload. Licensed RDHs matched to general dentistry, periodontics, pediatric dental, and DSO openings nationwide.',
    shortDescription: 'RDH roles across private practice, group dental (DSO), perio, pediatric dental, and public health.',
    commonCredentials: ['RDH', 'Licensed Dental Hygienist', 'Local Anesthesia certified'],
    exampleRoles: ['General Practice RDH', 'Pediatric RDH', 'Periodontics RDH', 'DSO Hygienist', 'Public Health RDH', 'Temp / PRN Hygienist'],
  },
  {
    slug: 'mental-health-tech',
    name: 'Mental Health Tech',
    title: 'Mental Health Tech / BHT resume upload',
    metaDescription: 'Free MHT / BHT resume upload. Mental Health and Behavioral Health Technicians matched to inpatient psych, residential, and crisis center openings.',
    shortDescription: 'Behavioral health tech roles across inpatient psych units, residential treatment, crisis stabilization, and substance use programs.',
    commonCredentials: ['MHT', 'BHT', 'CNA', 'CPI / Handle With Care', 'Mental Health First Aid'],
    exampleRoles: ['Inpatient Psych Tech', 'Adolescent Behavioral Health Tech', 'Crisis Stabilization Tech', 'Residential Treatment Tech', 'Substance Use Tech', 'Floor Lead BHT'],
  },
  {
    slug: 'bcba',
    name: 'Behavior Analyst (BCBA)',
    title: 'BCBA / ABA Therapist resume upload',
    metaDescription: 'Free BCBA resume upload. Board Certified Behavior Analysts and ABA clinicians matched to autism services, school, and clinic-based openings.',
    shortDescription: 'BCBA and ABA clinical roles across in-home autism services, clinic-based programs, schools, and clinical leadership.',
    commonCredentials: ['BCBA', 'BCaBA', 'BCBA-D', 'LBA'],
    exampleRoles: ['Clinic-based BCBA', 'In-Home BCBA', 'School-based BCBA', 'Clinical Director (ABA)', 'Regional BCBA', 'BCaBA / Mid-level Clinician'],
  },
  {
    slug: 'cath-lab-tech',
    name: 'Cath Lab Tech',
    title: 'RCIS / Cath Lab Tech resume upload',
    metaDescription: 'Free cath lab tech resume upload. RCIS / RCES / Cardiovascular Invasive Specialists matched to interventional cardiology and EP lab openings.',
    shortDescription: 'Cath lab and EP tech roles across interventional cardiology, electrophysiology, and structural heart programs.',
    commonCredentials: ['RCIS', 'RCES', 'CVT', 'ARRT (CV)'],
    exampleRoles: ['Cardiac Cath Lab Tech', 'Electrophysiology (EP) Tech', 'Structural Heart Tech', 'Lead Cath Lab Tech', 'Travel Cath Lab Tech', 'Cath Lab Manager'],
  },
  {
    slug: 'mri-tech',
    name: 'MRI Tech',
    title: 'MRI Tech / ARRT-MR resume upload',
    metaDescription: 'Free MRI tech resume upload. ARRT-MR registered MRI Technologists matched to hospital, outpatient imaging, and mobile MRI openings nationwide.',
    shortDescription: 'MRI Tech roles across hospital imaging, outpatient imaging centers, mobile MRI, and pediatric / cardiac MR.',
    commonCredentials: ['ARRT (MR)', 'ARRT (R)(MR)', 'ARMRIT'],
    exampleRoles: ['Hospital MRI Tech', 'Outpatient MRI Tech', 'Mobile MRI Tech', 'Pediatric MRI Tech', 'Cardiac MRI Tech', 'Lead MRI Tech'],
  },
]
